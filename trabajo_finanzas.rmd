...
### Rentabilidad Bruta
```{r}
rentabilidad_bruta_2022 <- as.numeric(estado_de_resultado[5,
    2]) / as.numeric(estado_de_resultado[1, 2])

rentabilidad_bruta_2021 <- as.numeric(estado_de_resultado[5,
...
rentabilidad_operacional_2022 <- as.numeric(estado_de_resultado[13,
    2]) / as.numeric(estado_de_resultado[1, 2])

rentabilidad_operacional_2021 <- as.numeric(estado_de_resultado[13,
    3]) / as.numeric(estado_de_resultado[1, 3])
